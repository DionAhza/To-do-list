...
class TaskController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('task')->with('success', 'The new task had successfully saved.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('task')->with('success', 'The task had successfully updated.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('task')->with('success', 'The task had successfully deleted.');
    }
}
